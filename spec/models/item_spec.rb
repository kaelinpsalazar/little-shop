...
RSpec.describe Item, type: :model do
  ...
  #   it 'returns all items that match a minimum price parameter' do
  ...
  #   it 'returns all items that match a maximum price parameter' do
  ...
  #   it 'returns all itmes that match a name' do
